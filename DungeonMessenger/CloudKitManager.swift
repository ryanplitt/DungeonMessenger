...
class CloudKitManager {
    ...
    var currentUserRecordID: CKRecordID { CKContainer.defaultContainer().fetchUserRecordIDWithCompletionHandler { (record, error) in
        return record
        }
    ...
    func requestDiscoverabilityPermission(completion: (() -> Void)?) {
